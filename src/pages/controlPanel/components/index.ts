...
export { default as FactoryReport } from './factoryReport'
export { default as FactoryEquipment } from './factoryEquipment'
export { default as FactoryPhotograph } from './factoryPhotograph'
