...
const spinUrl =
  'https://capacity-platform.oss-cn-hangzhou.aliyuncs.com/capacity-platform/platform/loadingGIf.gif'
...
const Loading = props => {
  ...
  return (
    <div className={styles.loadingGIf}>
      <img src={spinUrl} alt="" className={styles.loadingGIfImg} />
...
const StateTracking = () => {
  ...
  return (
    <div>
      <Spin spinning={loading} indicator={<Loading></Loading>}>
        ...
        {+curStep === 0 ? (
          <ConfirmTable curStep={+curStep}></ConfirmTable>
        ) : null}
